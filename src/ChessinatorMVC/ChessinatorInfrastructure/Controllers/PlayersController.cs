...
namespace ChessinatorInfrastructure.Controllers
{
    public class PlayersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TitleId,CurrentElo,PeakElo,FirstName,Username,LastName,TotalGamesCount,Birthday,Details,UserId,ProfilePicturePath,Id")] Player player)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TitleId,CurrentElo,PeakElo,FirstName,Username,LastName,TotalGamesCount,Birthday,Details,UserId,ProfilePicturePath,Id")] Player player)
        {
            if (id != player.Id)
            {
                return NotFound();
